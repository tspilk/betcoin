...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 41777 or testnet: 41778)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 41776 or testnet: 41778)") + "\n" +
        ...
        "\n" + _("SSL options: (see the BETCoin Wiki for SSL setup instructions)") + "\n" +
